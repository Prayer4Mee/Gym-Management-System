...
<script>
    ...
    function handleMonthChange(select) {
        ...
        // Redirect to the same page with the selected month as a URL parameter
        window.location.href = window.location.pathname + '?month=' + selectedMonth;
    }

    // Access the days and fees data in JavaScript
    var days = <?php echo $days_json; ?>;
    var fees = <?php echo $fees_json; ?>;

    // Set the selected option in the monthPicker select element
    var monthPicker = document.getElementById('monthPicker');
    monthPicker.value = '<?php echo $selectedMonth; ?>';

    // Use the data in your chart using JavaScript charting library (e.g., Chart.js)
    // Example:
